...
plt.style.use('default')  # Using 'default' instead of deprecated 'seaborn-v0_8'
...
axes[0,0].set_title('Orijinal Güncel Tercihler (İlk 10)\nOriginal Current Preferences (Top 10)', fontweight='bold')
axes[0,0].set_ylabel('Sayı (Count)')
...
axes[0,1].set_title('Gelişmiş Güncel Tercihler (İlk 10)\nEnhanced Current Preferences (Top 10)', fontweight='bold')
axes[0,1].set_ylabel('Sayı (Count)')
...
axes[1,0].set_title('Gelişmiş Tercih Dağılımı\nEnhanced Preferences Distribution', fontweight='bold')
...
axes[1,1].set_title('Analiz Güven Seviyeleri\nAnalysis Confidence Levels', fontweight='bold')
axes[1,1].set_ylabel('Sayı (Count)')
...
fig, axes = plt.subplots(2, 2, figsize=(16, 12))
fig.suptitle('Güncel Tercihe Göre Siyasi Tutumlar (Gelişmiş)\nPolitical Attitudes by Current Preference (Enhanced)', fontsize=16, fontweight='bold')
...
axes[0,0].set_title('Erken Seçim Desteği Tercihe Göre / Early Election Support by Preference\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[0,1].set_title('Başkanlık Sistemi Sonu Tercihe Göre / End Presidential System by Preference\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[1,0].set_title('AKP-CHP Koalisyon Desteği Tercihe Göre / AKP-CHP Coalition Support by Preference\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[1,1].set_title('Yeni Anayasa Desteği Tercihe Göre / New Constitution Support by Preference\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
fig.suptitle('Türk Siyasi Anket - Gelişmiş Semantik Analiz\nTurkish Political Survey - Enhanced Semantic Analysis', fontsize=20, fontweight='bold')

# 3.1 Demographics
# Age distribution
age_counts = df_enhanced['age'].value_counts()
axes[0,0].pie(age_counts.values, labels=age_counts.index, autopct='%1.1f%%', startangle=90)
axes[0,0].set_title('Yaş Dağılımı / Age Distribution', fontweight='bold')
...
axes[0,1].set_title('Gelir Dağılımı / Income Distribution', fontweight='bold')

# Education level
education_counts = df_enhanced['education'].value_counts()
axes[0,2].barh(education_counts.index, education_counts.values)
axes[0,2].set_title('Eğitim Seviyesi Dağılımı / Education Level Distribution', fontweight='bold')
...
axes[1,0].set_title('Son Oy vs Güncel Tercih (Gelişmiş) / Last Vote vs Current Preference (Enhanced)', fontweight='bold')
axes[1,0].tick_params(axis='x', rotation=45)
...
axes[2,0].set_title('Siyasi Tutumlar (Ortalama Puanlar) / Political Attitudes (Mean Scores)\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[2,1].set_title('Siyasi Arkadaşlık Toleransı / Political Friendship Tolerance\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[2,2].set_title('Hapis Görüşleri (Ortalama Puanlar) / Prison Opinions (Mean Scores)\n(1=Kesinlikle Katılmıyorum, 7=Kesinlikle Katılıyorum)', fontweight='bold')
...
axes[3,0].set_title('Sosyal Medya Kullanım Kalıpları / Social Media Usage Patterns', fontweight='bold')
...
plt.title('Siyasi Tutum Korelasyon Matrisi\nPolitical Attitudes Correlation Matrix', fontsize=16, fontweight='bold')
plt.tight_layout()
plt.show()
...
plt.title('Siyasi Kümeler Görselleştirmesi (PCA)\nPolitical Clusters Visualization (PCA)', fontsize=14, fontweight='bold')
plt.legend()
plt.grid(True, alpha=0.3)
plt.show()
...
colors = plt.cm.get_cmap('viridis')(np.linspace(0, 1, len(pie_data)))
wedges, texts, autotexts = ax1.pie(pie_data, labels=pie_labels, autopct='%1.1f%%', 
                                  startangle=90, colors=colors)
ax1.set_title('Ana Sorunlar - Gelişmiş Semantik Kategoriler\nMain Problems - Enhanced Semantic Categories', fontsize=12, fontweight='bold')
...
if wordcloud:
    ...
    ax2.axis('off')
    ax2.set_title('Ana Sorunlar Kelime Bulutu\nMain Problems Word Cloud', fontsize=12, fontweight='bold')
...
if semantic_network and len(semantic_network.nodes()) > 0:
    ...
    ax3.set_title('Kelime İlişki Ağı\nSemantic Network', fontsize=12, fontweight='bold')
    ax3.axis('off')
...
ax4.set_title('Gelişmiş Semantik Kelime Grupları\nEnhanced Semantic Word Groups', fontsize=12, fontweight='bold')
...
ax5.set_title('Kategorilere Göre Güven Seviyeleri\nConfidence Levels by Category', fontsize=12, fontweight='bold')
...
ax6.set_title('En Sık Kullanılan Kelimeler\nMost Frequently Used Words', fontsize=12, fontweight='bold')
...
ax7.set_title('Eğitim vs Ana Sorunlar (Frekans %)\nEducation vs Main Problems (Frequency %)', fontsize=12, fontweight='bold')
...
sns.heatmap(prob_age_top, annot=True, fmt='.1f', cmap='YlGnBu', ax=ax8,
            cbar_kws={'label': 'Yüzde (%)'})
ax8.set_title('Yaş vs Ana Sorunlar (Frekans %)\nAge vs Main Problems (Frequency %)', fontsize=12, fontweight='bold')
...
sns.heatmap(prob_income_top, annot=True, fmt='.1f', cmap='plasma', ax=ax9,
            cbar_kws={'label': 'Yüzde (%)'})
ax9.set_title('Gelir vs Ana Sorunlar (Frekans %)\nIncome vs Main Problems (Frequency %)', fontsize=12, fontweight='bold')
